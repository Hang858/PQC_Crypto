...
int crypto_kem_keypair(uint8_t *ek_kem, uint8_t *dk_kem) {
    ...
    uint8_t sigma[HQC_MAX_SECURITY_BYTES] = {0};
    uint8_t seed_pke[SEED_BYTES] = {0};
    shake256_xof_ctx ctx_kem;

    uint8_t ek_pke[HQC_MAX_PUBLIC_KEY_BYTES] = {0};
...
int crypto_kem_enc(uint8_t *c_kem, uint8_t *K, const uint8_t *ek_kem) {
    ...
    uint8_t m[HQC_MAX_SECURITY_BYTES] = {0};
    uint8_t K_theta[HQC_SHARED_SECRET_BYTES + HQC_SEED_BYTES] = {0};
...
int crypto_kem_dec(uint8_t *K_prime, const uint8_t *c_kem, const uint8_t *dk_kem) {
    ...
    uint8_t dk_pke[SEED_BYTES] = {0};
    uint8_t sigma[HQC_MAX_SECURITY_BYTES] = {0};
    uint8_t m_prime[HQC_MAX_SECURITY_BYTES] = {0};
    uint8_t hash_ek_kem[SEED_BYTES] = {0};
    uint8_t K_theta_prime[HQC_SHARED_SECRET_BYTES + HQC_SEED_BYTES] = {0};
    uint8_t K_bar[HQC_SHARED_SECRET_BYTES] = {0};
