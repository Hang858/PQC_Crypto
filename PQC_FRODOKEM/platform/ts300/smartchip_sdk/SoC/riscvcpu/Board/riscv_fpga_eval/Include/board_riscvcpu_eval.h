...
#ifndef _BOARD_RISCVCPU_EVAL_H_
#define _BOARD_RISCVCPU_EVAL_H_
...
#define SOC_BUTTON_1_HANDLER        clic_irq49_handler
#define SOC_BUTTON_2_HANDLER        clic_irq50_handler
// GPIO Bit Offset
