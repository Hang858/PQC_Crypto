 ...
 * @brief    PMP feature API header file for Smartchip RV/RVX Core
 */
/*
...
/* ===== PMP Operations ===== */
/**
 * \defgroup RMSIS_Core_PMP_Functions   PMP Functions
 * \ingroup  RMSIS_Core
...
/** @} */ /* End of Doxygen Group RMSIS_Core_PMP_Functions */
