 ...
 * @brief    FPU feature API header file for Smartchip RV/RVX Core
 */
/*
...
/* ===== FPU Operations ===== */
/**
 * \defgroup RMSIS_Core_FPU_Functions   FPU Functions
 * \ingroup  RMSIS_Core
 * \brief    Functions that related to the RISC-V FPU (F and D extension).
 * \details
 *
 * Smartchip provided floating point unit by RISC-V F and D extension.
...
/** @} */ /* End of Doxygen Group RMSIS_Core_FPU_Functions */
