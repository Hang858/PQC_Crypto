...
#ifndef __RMSIS_GCC_H__
#define __RMSIS_GCC_H__
/*!
 * @file     rmsis_gcc.h
 * @brief    RMSIS compiler GCC header file
 */
#include <stdint.h>
...
/**
 * \defgroup RMSIS_Core_CompilerControl    Compiler Control
 * \ingroup  RMSIS_Core
 * \brief    Compiler agnostic \#define symbols for generic c/c++ source code
 * \details
 *
 * The RMSIS-Core provides the header file <b>rmsis_compiler.h</b> with consistent \#define symbols for generate C or C++ source files that should be compiler agnostic.
 * Each RMSIS compliant compiler should support the functionality described in this section.
 *
 * The header file <b>rmsis_compiler.h</b> is also included by each Device Header File <device.h> so that these definitions are available.
 *   @{
 */
...
/* RMSIS compiler specific defines */
...
/** @} */ /* End of Doxygen Group RMSIS_Core_CompilerControl */

/* IO definitions (access restrictions to peripheral registers) */
/**
 * \defgroup RMSIS_Core_PeriphAccess     Peripheral Access
...
/** @} */ /* end of group RMSIS_Core_PeriphAccess */


#ifdef __cplusplus
}
#endif
#endif /* __RMSIS_GCC_H__ */
