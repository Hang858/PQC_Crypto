/*
 * Copyright (c) 2019 smartchip Limited. All rights reserved.
 *
 ...
 * @brief    Bitmanipulation feature API header file for smartchip RV/RVX Core
 */
/*
...
/**
 * \defgroup RMSIS_Core_Bitmanip_Intrinsic   Intrinsic Functions for Bitmanipulation Instructions
 * \ingroup  RMSIS_Core
 ...
 *
 * This intrinsic function support in compiler is introduced in smartchip riscv gcc 10.2.
 *
 * API header file can be found in lib/gcc/riscv-smartchip-elf/<gcc_ver>/include/rvintrin.h
 *
 *   @{
 */
/** @} */ /* End of Doxygen Group RMSIS_Core_Bitmanip_Intrinsic */
