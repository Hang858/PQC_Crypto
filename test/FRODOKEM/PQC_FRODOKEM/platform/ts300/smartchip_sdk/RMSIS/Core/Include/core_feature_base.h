 ...
 * @brief    Base core feature API for Smartchip RV/RVX Core
 */
#include <stdint.h>
...
/**
 * \defgroup RMSIS_Core_Registers     Register Define and Type Definitions
...
/** \brief Type of Control and Status Register(CSR), depends on the XLEN defined in RISC-V */
  ...
  typedef uint32_t rv_csr_t;
#endif
/** @} */ /* End of Doxygen Group RMSIS_Core_Registers */
/**
 * \defgroup RMSIS_Core_Base_Registers     Base Register Define and Type Definitions
...
typedef union {
    struct {
        ...
        rv_csr_t _reserved0:15;
        rv_csr_t dc_en:1;                       /*!< DCache enable */
        rv_csr_t _reserved1:__RISCV_XLEN-17;
    } b;                                        /*!< Structure used for bit  access */
    rv_csr_t d;                                 /*!< Type      used for csr data access */
} CSR_MCACHECTL_Type;
...
/**
 * \defgroup RMSIS_Core_CSR_Register_Access    Core CSR Register Access
 * \ingroup  RMSIS_Core
 * \brief    Functions to access the Core CSR Registers
 * \details
 *
 * The following functions or macros provide access to Core CSR registers.
 * - \ref RMSIS_Core_CSR_Encoding
 * - \ref RMSIS_Core_CSR_Registers
 *   @{
 */
 ...
 *              \ref RMSIS_Core_CSR_Registers, eg. \ref CSR_MSTATUS
...
/** @} */ /* End of Doxygen Group RMSIS_Core_CSR_Register_Access */

/* ###########################  CPU Intrinsic Functions ########################### */
/**
 * \defgroup RMSIS_Core_CPU_Intrinsic   Intrinsic Functions for CPU Intructions
 * \ingroup  RMSIS_Core
 ...
 * \details
 * Wait For Interrupt is is executed.
...
{
    __RV_CSR_SET(0x320, (1<<2));
}

/**
 * \brief   Enable  ILM ECC and 2 bit ECC exception
 */
__STATIC_FORCEINLINE void __enable_ilm_ecc(void)
{
    __RV_CSR_SET(0x7C0, 0x16);
}

/**
 * \brief   Disable ILM ECC and 2 bit ECC exception
 */
__STATIC_FORCEINLINE void __disable_ilm_ecc(void)
{
    __RV_CSR_CLEAR(0x7C0, 0x16);
}

/**
 * \brief   Enable  DLM ECC and 2 bit ECC exception
 */
__STATIC_FORCEINLINE void __enable_dlm_ecc(void)
{
    __RV_CSR_SET(0x7C1, 0x16);
}

/**
 * \brief   Disable DLM ECC and 2 Bit ECC exception
 */
__STATIC_FORCEINLINE void __disable_dlm_ecc(void)
{
    __RV_CSR_CLEAR(0x7C1, 0x16);
}
/**
...
/** @} */ /* End of Doxygen Group RMSIS_Core_CPU_Intrinsic */
