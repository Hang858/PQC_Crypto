...
#include "../../include/frodokem_api.h"
#define ALG_ID 0x01
    ...
    *out_len = 0;
    ...
    switch (cmd)
    {
        case 0x00:
            ...
            if (crypto_kem_keypair(level, dat_out, dat_out + frodokem_pk_len[level]))
            {
                return ERR_FAIL;
            }
        ...
        case 0x01:
            ...
            p_pk = dat_in + offset;
            if (crypto_kem_enc(level, dat_out, dat_out + frodokem_ct_len[level], p_pk))
            {
                return ERR_FAIL;
            }
