 ...
 */
/*******************************************************************************
 * @file     system_riscvcpu.h
 * @brief    RMSIS Smartchip RV/RVX Device Peripheral Access Layer Header File for
 *           Device <Device>
 * @version  V1.00
 * @date     17. Dec 2019
 ******************************************************************************/

#ifndef __SYSTEM_RISCVCPU_H__   /* ToDo: replace '<Device>' with your device name */
#define __SYSTEM_RISCVCPU_H__
 ...
 */
extern int32_t CLIC_Register_IRQ(IRQn_Type IRQn, CLIC_TRIGGER_Type trig_mode, uint8_t lvl, uint8_t priority, void *handler);

#ifdef __cplusplus
}
#endif

#endif /* __SYSTEM_RISCVCPU_H__ */
