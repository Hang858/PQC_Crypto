 ...
 * @brief    Cache feature API header file for Smartchip RV/RVX Core
 */
/*
...
/* ##########################  Cache functions  #################################### */
/**
 * \defgroup RMSIS_Core_Cache       Cache Functions
...
/** @} */ /* End of Doxygen Group RMSIS_Core_Cache */
#endif/* defined(__CCM_PRESENT) && (__CCM_PRESENT == 1) */

#if defined(__ICACHE_PRESENT) && (__ICACHE_PRESENT == 1)

/**
 * \defgroup RMSIS_Core_ICache      I-Cache Functions
 * \ingroup  RMSIS_Core_Cache
...
/**
 * \brief  Enable ICache ECC and 2 bit ECC exception
*/
__STATIC_FORCEINLINE void EnableICacheEcc (void)
{
    __RV_CSR_SET(CSR_MCACHE_CTL, 0x10c);
}
...
/**
 * \brief  Disable ICache ECC and 2 bit ECC exception
*/
__STATIC_FORCEINLINE void DisableICacheEcc (void)
{
    __RV_CSR_CLEAR(CSR_MCACHE_CTL, 0x10c);
}
...
#endif /* defined(__CCM_PRESENT) && (__CCM_PRESENT == 1) */
/** @} */ /* End of Doxygen Group RMSIS_Core_ICache */
#endif /* defined(__ICACHE_PRESENT) && (__ICACHE_PRESENT == 1) */

#if defined(__DCACHE_PRESENT) && (__DCACHE_PRESENT == 1)
/**
 * \defgroup RMSIS_Core_DCache      D-Cache Functions
 * \ingroup  RMSIS_Core_Cache
...
/**
 * \brief  Enable DCache ECC and 2 bit ECC exception
*/
__STATIC_FORCEINLINE void EnableDCacheEcc (void)
{
    __RV_CSR_SET(CSR_MCACHE_CTL, 0x00260000);
}
...
/**
 * \brief  Disable DCache ECC and 2 bit ECC exception
*/
__STATIC_FORCEINLINE void DisableDCacheEcc (void)
{
    __RV_CSR_CLEAR(CSR_MCACHE_CTL, 0x00260000);
}
...
/** @} */ /* End of Doxygen Group RMSIS_Core_DCache */
