 ...
 * @brief    Vector feature API header file for smartchip RV/RVX core
 */
/*
...
/**
 * \defgroup RMSIS_Core_Vector_Intrinsic   Intrinsic Functions for Vector Instructions
 * \ingroup  RMSIS_Core
 ...
 *
 * API header file can be found in lib/gcc/riscv-smartchip-elf/<gcc_ver>/include/riscv_vector.h
 *
 ...
 *   @{
 */
/** @} */ /* End of Doxygen Group RMSIS_Core_Vector_Intrinsic */
