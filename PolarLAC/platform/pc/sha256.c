...
static const uint32_t K[SHA256_K_SIZE] = {
...
static uint32_t RORc(uint32_t x, int32_t rot) {
...
{
    uint32_t S0, S1, S2, S3, S4, S5, S6, S7, W[SHA256_K_SIZE], t0, t1, t;
    int32_t i;
...
void SHA256_Update (SHA256_CTX *ctx, const void *src, uint32_t count)
{
...
void SHA256_Final (unsigned char *digest, SHA256_CTX *ctx)
{
    ...
    /*
     * The final state is an array of 32-bit words; place them as a series
